...
class JobrightJob(models.Model):
    title = models.CharField(max_length=500)
    company = models.CharField(max_length=300)
    location = models.CharField(max_length=300)
    apply_url = models.URLField(unique=True, max_length=2000)
    source = models.CharField(max_length=100, default="Jobright")
...
class JobrightScraperState(models.Model):
    STATUS_IDLE = "idle"
    ...
    class Meta:
        verbose_name_plural = "Jobright scraper state"
